var questions = {
	"1" : {
		...
		text: "What all action we can take to spread women's education across world?",
		votes: 1,
		responses: [
			{
				name: 'Amit',
				comment: "Promote gender equality, provide accessible education, and support women's empowerment through advocacy, scholarships, and educational initiatives."
			},
			{
				name: 'Rahul',
				comment: 'Thanks!'
